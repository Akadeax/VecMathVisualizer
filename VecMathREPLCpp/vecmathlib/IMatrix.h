...
class IMatrix
{
  public:
    ...
    static void binaryOp(IMatrix* op1, IMatrix* op2, std::function<float(float, float)> func, IMatrix* result);
    static void unaryOp(IMatrix* op1, std::function<float(float)> func, IMatrix* result);
    static void reduceToSum(IMatrix* op1, IMatrix* op2, std::function<float(float, float)> func, IMatrix* result);
